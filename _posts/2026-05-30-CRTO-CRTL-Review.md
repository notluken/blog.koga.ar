...
El acceso es vía Snap Labs. Podés hacer el lab una vez por día, lo que te obliga a planificar cada sesión y a no desperdiciarla. El de RTO I tiene un entorno de dominio con workstations, servidores y un DC. El de RTO II sube la complejidad considerablemente con más máquinas, más servicios y restricciones de red que te obligan a pensar en pivoting y en cómo se mueve el tráfico dentro del entorno. No es un laboratorio que te sostiene la mano: si algo no funciona, tenés que entender por qué.
